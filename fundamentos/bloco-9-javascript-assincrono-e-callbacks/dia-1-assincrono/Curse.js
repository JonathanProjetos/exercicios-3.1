...
// setTimeout() define um tempo para a execução de alguma atividade dado o valor em milissegundos.
// setInterval() define um padrão de repetição de intervalos.
// clearInterval() para uma determinada função em execução em um determinado tempo
...
const despesas = [
  ...
  // console.log(despesas.map((item)=> item));
